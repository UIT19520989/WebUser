...
const itemicons = [
    ...
    {
        key: '4',
        label: <Link to="#">{<GithubOutlined />}</Link>,
    },
];
...
function FooterCo() {
    return (
        <Footer>
            ...
            <Menu mode="horizontal" className="menu-nav-social" items={itemicons}>
                {/* <Menu.Item>
            ...
            <p className="copyright">
                {' '}
                Copyright © 2023 Muse by <a href="https://github.com/thoaiIT">NVT</a>.{' '}
            </p>
        </Footer>
    );
}
